<form wire:submit="uploadFile">
    ...
    <div class="flex gap-4">
      <template x-if="progress == 100">
        <div>
            <button type="button" class="inline px-4 py-3 font-bold text-white bg-blue-300 rounded-full cursor-pointer hover:bg-blue-100 hover:text-blue-900" wire:click="uploadFile" @click="progress = 0" @if ($showRefreshButton) disabled @endif>
                Save File
            </button>
