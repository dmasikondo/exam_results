...
<div class="my-4">
    ...
    <form wire:submit="login">
        ...
        <div  class="relative mt-4">
            <x-text-input wire:model="form.email" id="email" class="block w-full mt-1" type="email" name="email" required autofocus autocomplete="username"  placeholder="Email" />
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            @endif
                <p class="mx-1">
                    <a class="text-sm text-gray-600 underline hover:text-gray-900" href="/register">
                        {{ __(' Not registered?') }}
                    </a>
                </p>
